...
//Program  :To remove all the duplicate/same elements present in the Linked List.//
...
class SinglyLinearLL
{
    ...
    public:
            ...
            void DeleteDuplicate();   //to reverse the given Linked List
...
///////////////////////////////////////////////////////////////////////////////////
//
void SinglyLinearLL::DeleteDuplicate()
{
    PNODE temp,curr;
}
///////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    cout<<"\nModified Linked List (with duplicate elements removed): ";
    obj.DeleteDuplicate();
    obj.DisplayLL();
