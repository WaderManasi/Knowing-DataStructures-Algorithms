...
//Program  :To detect whether there is loop in (Singly Linear) Linked List       //
//          or is it NULL terminated                                             //
...
class SinglyLinearLL
{
    ...
    public:
            ...
            void DetectLoop();          //to reverse the given Linked List
...
///////////////////////////////////////////////////////////////////////////////////
//
void SinglyLinearLL::DetectLoop()
{
    PNODE slowPtr=head,fastPtr=head;
